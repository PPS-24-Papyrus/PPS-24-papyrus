...
class TableTest extends AnyFunSuite with Matchers:
  ...
  test("Table should render correctly with caption and rows"):
    ...
    table.render shouldEqual "<div class=\"cls-3E8\"><table><caption>Table Caption</caption><tbody><tr><th colspan='1' rowspan='1'>Cell 1</th><td colspan='1' rowspan='1'>Cell 2</td></tr></tbody></table></div>"
  ...
  test("Table should render correctly without caption"):
    ...
    table.render shouldEqual "<div class=\"cls-3E9\"><table><tbody><tr><td colspan='1' rowspan='1'>Cell 1</td><td colspan='1' rowspan='1'>Cell 2</td></tr></tbody></table></div>"
