...
import papyrus.logic.builders.{ContentBuilder, ImageBuilder, MainStyleBuilder, MetadataBuilder, PapyrusBuilder, TextBuilder, TextDSL, TitleBuilder}
  ...
  @main def provaFunc(): Unit =
    papyrus:
      ...
      content:
        ...
        image:
          "C:\\Users\\danie\\OneDrive\\Documenti\\GitHub\\PPS-24-papyrus\\download.jpg" alternative "Immagine di esempio" caption "Esempio di immagine" width 500 alignmentImage "left"
